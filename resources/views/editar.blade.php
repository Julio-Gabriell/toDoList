    ...
    <form action="{{ route('tarefas.edit', $tarefa->id) }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="tituloTarefa" name="titulo" class="form-control"
                value="{{ old('titulo', $tarefa->titulo) }}" placeholder="Ex: Entregar atividade da Faculdade">
        </div>
        ...
        <div class="justify-content-center d-flex gap-2">
            <button type="submit" class="btn btn-success">Salvar Alterações <i class="fa-solid fa-check"></i></button>
            <a href="{{ route('tarefas.home') }}" class="btn btn-danger">Cancelar Alterações <i
